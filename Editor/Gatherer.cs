...
namespace jp.lilxyzw.assetgrimoire
{
    internal static class Gatherer
    {
        [MenuItem("Tools/lilAssetGrimoire/Output GUIDs")]
        ...
        [MenuItem("Tools/lilAssetGrimoire/Make Target (Folder)")]
        ...
        [MenuItem("Tools/lilAssetGrimoire/Update Database")]
        ...
        #if LIL_SHADPZIPLIB
        [MenuItem("Tools/lilAssetGrimoire/Make Target (Unitypackage)")]
